        ...
        {TOUR_PACKAGES.map((pkg, idx) => (
          ...
          >
            <div className="relative h-48 overflow-hidden">
              ...
              />
              <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-md px-2.5 py-1 rounded-full text-xs font-normal text-zinc-900 flex items-center gap-1 border border-zinc-200 shadow-sm">
            ...
            <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
              <div>
                ...
                <h3 className="text-base font-normal text-zinc-900 group-hover:text-zinc-700 transition-colors line-clamp-2">
                  {pkg.title}
                </h3>
              </div>
              ...
              <div className="space-y-2 pt-2 border-t border-zinc-200">
                <div className="flex flex-col gap-1 text-xs text-zinc-600">
                  ...
                  <span className="text-zinc-900 font-medium">{pkg.price}</span>
                </div>

                <button
                  onClick={onOpenBooking}
                  className="w-full mt-3 flex items-center justify-center gap-2 bg-zinc-900 hover:bg-black text-white py-2 rounded-xl text-xs font-normal transition-colors"
                >
