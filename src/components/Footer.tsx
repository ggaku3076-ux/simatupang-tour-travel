...
export const Footer: React.FC = () => {
  const { contactInfo, isAdminLoggedIn, setIsAdminPanelOpen } = useAdmin();
            ...
            <div className="space-y-2.5 text-zinc-300">
              <div className="flex items-center gap-2.5 bg-zinc-900 p-2.5 rounded-xl border border-zinc-800">
                ...
                <div>
                  ...
                  <a href={`https://wa.me/${contactInfo.whatsappRaw}`} target="_blank" rel="noreferrer" aria-label={`Hubungi WhatsApp ${contactInfo.phone}`} className="text-white font-bold hover:underline">
                    {contactInfo.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5 bg-zinc-900 p-2.5 rounded-xl border border-zinc-800">
                ...
                <div>
                  ...
                  <span className="text-white font-bold">{contactInfo.email}</span>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-zinc-400 font-medium">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-zinc-500 hover:text-emerald-400 bg-zinc-900 hover:bg-zinc-800 px-3 py-1 rounded-full border border-zinc-800 text-[11px] transition-colors"
            >
